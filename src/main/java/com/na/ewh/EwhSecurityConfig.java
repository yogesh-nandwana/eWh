...
public class EwhSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
			...
			.antMatchers("/customers","/savecustomer","/logout").hasAnyRole("USER","ADMIN")
			.antMatchers("/admin", "/h2-console/**").hasRole("ADMIN")
			.and().csrf().ignoringAntMatchers("/h2-console/**","/savecustomer")//don't apply CSRF protection to /h2-console
